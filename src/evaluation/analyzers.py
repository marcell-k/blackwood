...
from src.config import ANNUAL_TRADING_DAYS, CASH, RISK_FREE_RATE
from src.evaluation.utils import (
    BinnedIndicatorAnalyzer,
    BinStrategy,
    PerformanceAnalyzer,
)
from src.visualization.core import BacktestVisualizer, ChartConfig
...
class StrategyVsBuyHoldAnalyzer:
    ...
    def get_bh_stats(self):
        from src.strategies.base import BuyAndHoldStrategy
...
class TradingDashboard:
    ...
    def create_dashboard(
        ...
        from src.visualization.core import BacktestVisualizer
